...
public class EntranceRegister extends MemberEntranceRecord{
    ...
    public EntranceRegister(String name, Date dateOfBirth, String nicNumber, Long memberID, Date dateOfRegistration, Date dateOfExpiration, String credential, Member member, Time timeArrived, Time timeLeft, Date date, MemberEntranceRecord memberEntranceRecord, GuestEntranceRecord guestEntranceRecord) {
